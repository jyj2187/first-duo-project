...
public class TestDataInit {
    ...
    public void inIt(){
        ...
        postRepository.save(new Posts("사랑합니다",member1,"반가워요", null, PostType.CHAT));
        postRepository.save(new Posts("좋아합니다",member1,"감사해요", null, PostType.CHAT));
        postRepository.save(new Posts("고맙습니다",member1,"안녕하세요", null, PostType.CHAT));
        postRepository.save(new Posts("관리자 뭐하냐",member2,"밑에지워라", null, PostType.CHAT));
        postRepository.save(new Posts("아름답네요",member2,"밑에지워라", null, PostType.CHAT));
        postRepository.save(new Posts("사랑합니다",member1,"반가워요", null, PostType.CHAT));
        postRepository.save(new Posts("좋아합니다",member1,"감사해요", null, PostType.CHAT));
        postRepository.save(new Posts("고맙습니다",member1,"안녕하세요", null, PostType.CHAT));
        postRepository.save(new Posts("관리자 뭐하냐",member2,"밑에지워라", null, PostType.CHAT));
